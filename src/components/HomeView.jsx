...
export default function HomeView({ currentCount, userData, isTodayGoalMet, progress, weekDays, streakCount, canClaimMatcha = false, daysUntilNextClaim = 7 }) {
        ...
        <>
            ...
            <div className="bg-white w-full rounded-[2rem] p-7 shadow-[0_10px_40px_rgba(0,0,0,0.04)] border border-gray-100 mb-4 relative overflow-hidden">
                ...
                <div className="flex items-center gap-6 mb-6 h-32">
                    {/* Character image */}
                    <div className="w-32 h-32 flex-shrink-0 rounded-2xl bg-[#F9F9FB] flex items-center justify-center overflow-hidden">
                        <img
                            src={stage.img}
                            alt="Character"
                    ...
                    <div className="flex-1 min-w-0">
                        <p className="text-[16px] font-semibold text-[#1C1C1E] leading-snug mb-2">
                            {stage.text}
                        </p>
                        {!isTodayGoalMet && (
            ...
            <div className="w-full mb-4">
                <div className="bg-white rounded-[2rem] shadow-[0_5px_25px_rgba(0,0,0,0.03)] border border-gray-100 overflow-hidden">
                    {/* Streak row */}
                    <div className="px-5 py-4 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] font-medium mt-0.5" style={{ color: canClaimMatcha ? '#EAB0BE' : '#FF9500' }}>
                                    {canClaimMatcha
                                        ? '🍵 Matcha unlocked!'
                                        : `🍵 ${daysUntilNextClaim} day${daysUntilNextClaim !== 1 ? 's' : ''} till matcha`
                                    }
                                </p>
                            </div>
                        </div>
