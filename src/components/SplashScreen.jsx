...
export default function SplashScreen({ type }) {
    ...
    if (type === 'auth') return (
        <div className="bg-[#ffffff] sm:bg-[#EAB0BE] fixed inset-0 w-full h-full flex items-center justify-center z-50">
    ...
    return (
        <div className="bg-[#ffffff] sm:bg-[#EAB0BE] fixed inset-0 w-full h-full flex items-center justify-center font-sans text-[#1C1C1E] antialiased z-50">
            <style dangerouslySetInnerHTML={{ __html: globalCss }} />
            <main className="bg-[#ffffff] w-full h-full sm:h-[844px] sm:max-w-[390px] sm:rounded-[3rem] flex flex-col items-center justify-center relative sm:shadow-2xl sm:ring-1 sm:ring-[#EAB0BE]/30 overflow-hidden">
